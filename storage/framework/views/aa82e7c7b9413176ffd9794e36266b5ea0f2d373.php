...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('users.create')); ?>" class="btn btn-sm btn-success"> <?php echo e(__('messages.New')); ?> <?php echo e(__('messages.Customers')); ?></a>
        </div>
        <div class="card-body">
                    ...
                    <?php if(@isset($data) && !@empty($data) && count($data) > 0): ?>
                        <table id="example2" class="table table-bordered table-hover">
                            <thead class="custom_thead">
                                ...
                                <th><?php echo e(__('messages.user_type')); ?></th>
                                <th></th>
                            </thead>
                            <tbody>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($info->user_type == 1 ? "تأمين" : "محل عادي"); ?></td>
                                        <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ali_car\resources\views/admin/users/index.blade.php ENDPATH**/ ?>